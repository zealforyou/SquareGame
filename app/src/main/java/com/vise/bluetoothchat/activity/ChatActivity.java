...
public class ChatActivity extends BaseChatActivity implements EmojiconsFragment.OnEmojiconBackspaceClickedListener,
    ...
    private void sendMessage() {
        ...
        friendInfo.setBluetoothDevice(mBluetoothChatHelper.getAdapter().getRemoteDevice(mBluetoothChatHelper.getAdapter()
                .getAddress()));
        ...
        try {
            if (mIsSendFile && mSendFile != null) {
                ...
                sharingIntent.setComponent(new ComponentName("com.android.bluetooth", "com.android.bluetooth.opp" +
